...
void MainScene::Init() {
    ...
    // Load Resources
    Manager::TextureMgr.CreateTextureFromFile(L"res/stonecutter.png", L"stone");
    Manager::TextureMgr.CreateTextureFromFile(L"res/bg.png", L"bg");
    ...
    image_bg.SetTexture(Manager::TextureMgr.GetTexture(L"bg"));
    ...
    image_player.SetTexture(Manager::TextureMgr.GetTexture(L"stone"));
